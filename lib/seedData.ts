...
export const dailySupportMessages = [
  "היום לא צריך להספיק הכל. מספיק לסדר את הדבר הבא על השולחן, ואז להמשיך משם.",
  "סדנה טובה מתחילה בפרט קטן שמישהו שם לב אליו בזמן.",
  "אם היום עמוס, מתחילים מהאירוע הקרוב ביותר. אחר כך העולם חוזר לגודל נורמלי.",
  "אלונה, לא כל דבר צריך להיפתר עכשיו. מה שצריך להיארז היום מקבל קדימות.",
  "כלים, לקוחות, הודעות, משלוחים. אחד אחד. הסטודיו עובד הכי טוב בקצב יציב.",
  "הדבר הכי חשוב היום הוא לא לשכוח את מה שכבר הובטח ללקוח.",
  "גם יום מבולגן יכול להיגמר מסודר אם מסמנים רק שלוש משימות אמיתיות.",
  "אם יש ספק, פותחים אירוע, בודקים תאריך, בודקים כלים, בודקים מי מגיעה.",
  "הלקוחות זוכרים את ההרגשה. המערכת פה כדי לשמור על הפרטים הקטנים.",
  "להתחיל מהמלאי הנמוך זה לא דרמה, זה פשוט לדאוג לאלונה של מחר.",
  "מה שלא ברור עכשיו נכנס להערה פנימית. לא מחזיקים דברים בראש בכוח.",
  "הסטודיו לא צריך להיות מושלם כדי לעבוד טוב. הוא צריך להיות ברור.",
  "היום בוחרים פעולה אחת שמורידה לחץ: שיחה, סידור, גלזורה או אריזה.",
  "כל אירוע שסגור טוב מפנה מקום לאירוע הבא להיכנס בשקט.",
  "אם משהו מרגיש מפוזר, זה סימן לפתוח את הסידור החודשי ולראות את התמונה."
];
